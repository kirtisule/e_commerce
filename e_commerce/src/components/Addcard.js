...
const Addcard = () => {
  ...
  useEffect(()=>{
    ...
    if(carts.length==0) {
        return <div className='h-[55vh] flex justify-center text-4xl item-center'>Card is Empty</div>
    }
    const handleInc=(id)=>{
            ...
            <div className="container mx-auto mt-10">
                <div className="flex shadow-md my-10">
                    <div className="w-3/4 bg-white px-10 py-10">
                                ...
                                return (
                                    ...
                                    <div className="flex w-2/5">
                                        ...
                                        <div className="flex flex-col justify-between ml-4 flex-grow">
                                            ...
                                            <div className="font-semibold hover:text-red-500 text-gray-500 text-xs cursor-pointer"onClick={()=>handlRemove(cart?.id)}>Remove</div>
                                        </div>
                                    </div>
                        ...
                        <Link to='/productcard' className="flex font-semibold text-indigo-600 text-sm mt-10">
